        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-12 col-lg-4 m-auto">
                <div class="image-wrapper md-pb">
                    <img class="w-100 lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" alt="" loading="lazy" data-src="assets/images/vente-achat-location-hypotheque-maison-108855-1795-626x521.jpg">
                </div>
            </div>
            <div class="col-12 col-md-12 col-lg m-auto">
                <div class="text-wrapper align-left">
                    ...
                    <p class="mbr-text mbr-fonts-style display-7">
                        Description de l'agence immobilière</p>
                    <div class="mbr-section-btn mt-3"><a class="btn btn-lg btn-warning display-4" href="#"><span class="mobi-mbri mobi-mbri-edit mbr-iconfont mbr-iconfont-btn"></span>Modifier</a></div>
                </div>
            </div>
        </div>
    </div>
...
<section data-bs-version="5.1" class="info3 cid-sLWrPABACN" id="info3-1k">
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-xs-12 text-block col-sm-5">
                ...
                <h3 class="mbr-section-subtitle mbr-fonts-style pb-3 align-left display-5">
                    <em>Domaine: sudoimmo.katalog.com</em></h3>
                <div class="mbr-section-text mbr-fonts-style align-left display-7">Adresse</div>
                <div class="underline align-left">
                    <div class="line"></div>
                </div>
                <div class="mbr-section-text mbr-fonts-style align-left display-7"><span>Tél WhatsApp :&nbsp;</span></div>
                <div class="underline align-left">
                    <div class="line"></div>
                </div>
                <div class="mbr-section-text mbr-fonts-style align-left display-7">
                    <span>Tél perso: +1 (0) 000 0000 001 <br>
                        youremail@mail.com
                    </span>
                </div>
                <div class="social-media pt-4 align-left">
                    <ul class="list-inline">
                        ...
                        <li class="list-inline-item">
                            <a class="icon-transition" href="#">
                                <span class="mbr-iconfont fa-snapchat fa"></span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-xs-12 col-sm-7 img-block align-center">
                <div class="mbr-figure">
                    <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" alt="" title="" loading="lazy" class="lazyload" data-src="assets/images/mbr-1476x984.jpg">
                </div>
            </div>
        </div>
    </div>
