    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto mbr-form" >
                <!--Formbuilder Form-->
                <form action="{{ route('service.update',compact('agence','service')) }}" method="POST" class="mbr-form form-with-styler"
                    ...
                    <div class="dragArea form-row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <h4 class="mbr-fonts-style display-5">Formulaire de Modification - Service</h4>
                        </div>
                        <div >
                        ...
                        <div data-for="nom" class="col-lg-12 col-md-12 col-sm-12 form-group">
                            ...
                            <input type="text" name="nom" placeholder="Nom du service" data-form-field="nom"
                                class="form-control display-7" required="required" value="{{old('nom') ?? $service->nom}}" id="nom-formbuilder-3d">
                        </div>
