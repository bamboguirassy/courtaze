            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-12 col-lg m-auto">
                    <div class="text-wrapper align-left">
                        ...
                        <p></p>
                        <div class="mbr-section-btn mt-3"><a class="btn btn-lg btn-primary display-4" href="#news2-37"><span
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto mbr-form">
                    <!--Formbuilder Form-->
                    <form action="{{ route('agence-social-link.store', compact('agence')) }}" method="POST"
                        class="mbr-form form-with-styler" data-form-title="socialNetworkLinkForm">
                        @csrf
                        @method('post')
                        ...
                        <div class="dragArea form-row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="reseau_social_id" style="">
                                ...
                                <select name="reseau_social_id" data-form-field="reseau_social_id"
                                    class="form-control display-7" id="reseau_social_id-formbuilder-38">
            ...
            @foreach ($socialLinks as $socialLink)
                <div class="row inline">
                    <div class="col-12 col-sm-4">
                        <p class="date mbr-fonts-style display-7">{{ $socialLink->reseauSocial->nom }}</p>
                    </div>
                    <div class="col-12 col-sm-4">
                        <p class="workplace mbr-fonts-style display-4">
                            <a target="_blank" href="{{ $socialLink->lien  }}">{{ $socialLink->lien  }}</a>
                        </p>
                    </div>
