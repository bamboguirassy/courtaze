    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto mbr-form">
                <!--Formbuilder Form-->
                <form action="{{ route('reseau-social.update',$reseauSocial->id) }}" method="POST" class="mbr-form form-with-styler"
                    ...
                    <div class="dragArea form-row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="nom" style="">
                            ...
                            <input type="text" name="nom" data-form-field="nom" class="form-control display-7"
                                required="required" value="{{ old('nom') ?? $reseauSocial->nom }}" id="nom-formbuilder-3m">
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="icon">
                            ...
                            <input type="text" name="icon" data-form-field="icon" class="form-control display-7"
                                required="required" value="{{ old('icon') ?? $reseauSocial->icon }}" id="icon-formbuilder-3m">
                        </div>
