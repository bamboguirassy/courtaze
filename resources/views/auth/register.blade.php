            ...
            <div class="col-lg-8 mx-auto mbr-form">
                ...
                <form action="{{ route('register.request') }}" method="POST" class="mbr-form form-with-styler"
                    ...
                    <div class="dragArea form-row">
                        ...
                        <div data-for="type_id" class="col-lg-12 col-md-12 col-sm-12 form-group">
                            <label for="type_id-formbuilder-u"
                                class="form-control-label mbr-fonts-style display-7">Type</label>
                            <select name="type_id" data-form-field="type_id" class="form-control display-7"
                                id="type_id-formbuilder-u">
                        ...
                        <div data-for="name" class="col-lg-12 col-md-12 col-sm-12 form-group">
                            <label for="name-formbuilder-u" class="form-control-label mbr-fonts-style display-7">Nom
                                complet</label>
                            <input type="text" name="name" placeholder="Nom complet" data-form-field="name"
                                class="form-control display-7" required="required" value="" id="name-formbuilder-u">
                        </div>
                        <div data-for="slogan" class="col-lg-12 col-md-12 col-sm-12 form-group">
                            ...
                            <input type="text" name="slogan" placeholder="Slogan de l'agence" data-form-field="slogan"
                                class="form-control display-7" required="required" value="" id="slogan-formbuilder-u">
                        </div>
                        <div data-for="domain" class="col-lg-12 col-md-12 col-sm-12 form-group">
                            ...
                            <input type="text" name="domain" placeholder="Nom de domaine" data-form-field="domain"
                                required="required" class="form-control display-7" value="" id="domain-formbuilder-u">
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="color">
                            ...
                            <input type="text" name="color" data-form-field="color" required="required"
                                class="form-control display-7" value="" id="color-formbuilder-u">
                        </div>
                        <div data-for="description" class="col-lg-12 col-md-12 col-sm-12 form-group">
                            ...
                            <textarea name="description" placeholder="Description de l'agence"
                                ...
                                id="description-formbuilder-u"></textarea>
                        </div>
                        ...
                        <div data-for="telephoneWhatsapp" class="col-lg-12 col-md-12 col-sm-12 form-group">
                            <label for="telephoneWhatsapp-formbuilder-u"
                                class="form-control-label mbr-fonts-style display-7">Téléphone WhatsApp</label>
                            <input type="text" name="telephoneWhatsapp" data-form-field="telephoneWhatsapp"
                        ...
                        <div data-for="telephonePersonnel" class="col-lg-12 col-md-12 col-sm-12 form-group">
                            ...
                            <input type="text" name="telephonePersonnel" placeholder="Téléphone personnel"
                                data-form-field="telephonePersonnel" required="required" class="form-control display-7"
                                value="" id="telephonePersonnel-formbuilder-u">
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <hr>
                        </div>
