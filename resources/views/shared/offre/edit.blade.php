        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-12 col-lg m-auto">
                <div class="text-wrapper align-left">
                    <h1 class="mbr-section-title mbr-fonts-style mb-4 display-2"><strong>Modification -
                            {{$offre}}</strong></h1>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-10 mx-auto mbr-form">
                <!--Formbuilder Form-->
                <form action="{{ route('offre.update',compact('offre')) }}" method="POST" data-rcpha_sitekey=""
                    data-rcpha_secretkey="" class="mbr-form form-with-styler">
                    @csrf
                    @method('put')
                    ...
                    <div class="dragArea form-row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <h4 class="mbr-fonts-style display-5"><strong>Modification de l'offre: {{$offre}}</strong>
                            </h4>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <hr>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="nombreAppartement">
                            ...
                            <select class="form-control" name="proposition" id="proposition">
                                ...
                                <option @if(old('proposition')=='Location' || $offre->proposition=='Location') selected
                                ...
                                <option @if(old('proposition')=='Vente' || $offre->proposition=='Vente') selected
                                    @endif>Vente</option>
                                @endif
                                @if ($categorieBien->code=="HOTE")
                                <option @if(old('proposition')=='Nuitée' || $offre->proposition=='Nuitée') selected
                                    @endif>Nuitée</option>
                                @endif
                            </select>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="nombreEtage">
                            ...
                            <input type="number" name="nombreEtage" data-form-field="nombreEtage"
                                class="form-control display-7" value="{{ old('nombreEtage') ?? $offre->nombreEtage }}"
                                id="nombreEtage-formbuilder-c">
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="nombreAppartement">
                            <label for="nombreAppartement-formbuilder-c"
                                class="form-control-label mbr-fonts-style display-7"><strong>Nombre
                                    d'appartements</strong></label>
                            <input type="number" name="nombreAppartement" data-form-field="nombreAppartement"
                                class="form-control display-7"
                                value="{{ old('nombreAppartement') ?? $offre->nombreAppartement }}"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="nombreStudio" style="">
                            ...
                            <input type="number" name="nombreStudio" data-form-field="nombreStudio"
                                class="form-control display-7" value="{{ old('nombreStudio') ?? $offre->nombreStudio }}"
                                id="nombreStudio-formbuilder-c">
                        </div>
                        @endif
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="superficie" style="">
                            ...
                            <input type="number" name="superficie" min="0" step="1" data-form-field="superficie"
                                ...
                                value="{{ old('superficie') ?? $offre->superficie }}" id="superficie-formbuilder-c">
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="longueur" style="">
                            ...
                            <input type="number" name="longueur" min="0" step="any" data-form-field="longueur"
                                class="form-control display-7" value="{{ old('longueur') ?? $offre->longueur }}"
                                id="longueur-formbuilder-c">
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="largeur" style="">
                            ...
                            <input type="number" name="largeur" min="0" step="any" data-form-field="largeur"
                                class="form-control display-7" value="{{ old('largeur') ?? $offre->largeur }}"
                                id="largeur-formbuilder-c">
                        </div>
                        @endif
                        @if ($categorieBien->code=="STUDIO" || $categorieBien->code=="APPART")
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" style="" data-for="nombreChambre">
                            ...
                            <input type="number" name="nombreChambre" data-form-field="nombreChambre"
                                class="form-control display-7"
                                value="{{ old('nombreChambre') ?? $offre->nombreChambre }}"
                                id="nombreChambre-formbuilder-c">
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="nombreChambreAvecToilette">
                            ...
                            <input type="number" name="nombreChambreAvecToilette"
                                data-form-field="nombreChambreAvecToilette" class="form-control display-7"
                                value="{{ old('nombreChambreAvecToilette') ?? $offre->nombreChambreAvecToilette }}"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" style="">
                            ...
                            <div data-for="Meublé" class="form-check form-check-inline">
                                <input @if(old('isMeuble') || $offre->isMeuble) checked @endif type="checkbox" value="1"
                                name="isMeuble" data-form-field="Meublé"
                            ...
                            <div data-for="Garage" class="form-check form-check-inline">
                                <input @if(old('hasGarage') || $offre->hasGarage) checked @endif type="checkbox"
                                value="1" name="hasGarage" data-form-field="Garage"
                            ...
                            <div data-for="Cuisine" class="form-check form-check-inline">
                                <input @if(old('hasCuisine') || $offre->hasCuisine) checked @endif type="checkbox"
                                value="1" name="hasCuisine" data-form-field="Cuisine"
                            ...
                            <div data-for="hasToilettePublique" class="form-check form-check-inline">
                                <input @if(old('hasToilettePublique') || $offre->hasToilettePublique) checked @endif
                                type="checkbox" value="1" name="hasToilettePublique"
                            ...
                            <div data-for="Avec salon" class="form-check form-check-inline">
                                <input @if(old('hasSalon') || $offre->hasSalon) checked @endif type="checkbox" value="1"
                                name="hasSalon" data-form-field="Avec salon"
                            ...
                            <div data-for="Avec toilette intérieure" class="form-check form-check-inline">
                                <input @if(old('hasToiletteInterieure') || $offre->hasToiletteInterieure) checked @endif
                                type="checkbox" value="1" name="hasToiletteInterieure"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="niveau" style="">
                            ...
                            <div class="form-check form-check-inline">
                                <input @if(old('niveau')=='Rez-de-chaussée' || $offre->niveau=='Rez-de-chaussée')
                                checked @endif type="radio" name="niveau" data-form-field="niveau"
                            ...
                            <div class="form-check form-check-inline">
                                <input @if(old('niveau')=='Etage' || $offre->niveau=='Etage') checked @endif
                                type="radio" name="niveau" data-form-field="niveau"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="nombreCuisine">
                            ...
                            <input type="number" name="nombreCuisine" data-form-field="nombreCuisine"
                                class="form-control display-7"
                                value="{{ old('nombreCuisine') ?? $offre->nombreCuisine }}"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="ville" style="">
                            ...
                            <input value="{{old('villeLatitude') ?? $offre->villeLatitude}}" type="number" name="villeLatitude" id="villeLatitude" ng-model="lat" step="any" hidden>
                            <input value="{{old('villeLongitude') ?? $offre->villeLongitude}}" type="number" name="villeLongitude" id="villeLongitude" ng-model="lng" step="any" hidden>
                            <input gm-places-autocomplete ng-model="placeAutoComplete" type="text" name="ville"
                                placeholder="Ville" data-form-field="ville" required="required"
                                class="form-control display-7" value="{{ old('ville') ?? $offre->ville }}"
                                id="ville-formbuilder-c">
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="adresse">
                            <label for="adresse-formbuilder-c"
                                class="form-control-label mbr-fonts-style display-7"><strong>Adresse exacte</strong></label>
                            <textarea name="adresse" placeholder="Adresse" data-form-field="adresse" required="required"
                                class="form-control display-7"
                                id="adresse-formbuilder-c">{{ old('adresse') ?? $offre->adresse }}</textarea>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="prix">
                            ...
                            <input type="number" name="prix" placeholder="Prix" min="5000" step="5"
                                data-form-field="prix" required="required" class="form-control display-7"
                                value="{{ old('prix') ?? $offre->prix }}" id="prix-formbuilder-c">
                        </div>
                        ...
                        <div class="col-auto"><button type="submit" class="btn btn-warning display-7">Mettre à
                                jour</button></div>
                    </div>
                </form>
                <!--Formbuilder Form-->
